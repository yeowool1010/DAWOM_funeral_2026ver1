            ...
            <div className="rounded-2xl bg-white px-5 py-7 shadow-sm md:px-7">
              ...
              <ol className="mt-5 space-y-4 text-sm text-slate-700 md:text-base">
                ...
                <li className="flex gap-3">
                  ...
                  <p>
                    그 외, 장례 관련 상담이 필요할 때{" "}
                    <span className="font-semibold">032-344-4446</span>로 연락
                    주세요.
                  </p>
                </li>
              </ol>
            ...
            <div className="mt-8">
              ...
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
                {[
                  ...
                  {
                    name: "가진 수의",
                    name2: "가진 수의란 '갖춰진 수의'를 뜻합니다. 일반적으로 저고리(속저고리)·바지(속바지)·베개·악수·복건·면모·턱받이·버선·오낭·천금(이불)·지금(요)·장매·멧베 등으로 구성되어 있으며 입관시 고인 모실 때 사용됩니다.",
                    desc: "",
                    price: "",
                    discount: "",
                    img: "/images/수의.png",
                  ...
                  {
                    name: "장례 초도 용품",
                    name2: "초도 용품이란 장례 시작을 위해 빈소에 기본적으로 갖춰야 하는 용품으로 위패, 명패, 향, 양초, 향로, 촛대, 혼백, 부의록 등을 아울러 표현합니다.",
                    desc: "",
                    price: "",
                    discount: null,
                    img: "/images/products/장례 초도 용품.png",
                  },
                  {
                    name: "봉안함",
                  ...
                  {
                    name: "꽃관 장식",
                    name2: "꽃관장식이란 고인의 관 내부를 꽃으로 장식하는 것입니다. 고인께서 긴 여행을 떠나시는 길을 생화로 아름답게 보내드리는 것을 의미합니다. 생화 종류는 계절에 따라 바뀔 수 있습니다.",
                    desc: "계절 생화",
                    price: "",
                    discount: null,
                    img: "/images/관장식꽃.jpg",
                  ...
                  {
                    name: "남자상복/여자상복",
                    name2: "장례 중 유족이 입는 예복입니다. 남자는 와이셔츠,넥타이가 포함된 정장, 여자는 치마와 저고리로 구성되어 있습니다. ",
                    desc: "남자 4벌, 여자 6벌",
                    price: "",
                    discount: null,
                  ...
                  {
                    name: "헌화용 국화꽃",
                    name2: "헌화는 장례식장에서 고인에게 꽃을 바쳐 애도와 추모의 마음을 전하는 행위로, 보통 흰 국화를 사용합니다. 일반적으로 30송이 정도 사용해 3일 동안 돌려가며 사용합니다.",
                    desc: "30송이",
                    price: "",
                    free: true,
              ...
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
                {[
                  ...
                  },
                  {
                    name: "입관지도사",
                    name2:
                      "입관시 담당 장례지도사를 도와 고인을 모시는 장례지도사입니다. 장례지도사와 마찬가지로 장례에 관한 전문가입니다.",
                    desc: "",
                    price: "",
                  ...
                  },
                  {
                    name: "접객도우미",
                    name2:
                      "정식 명칭은 장례관리사입니다. 장례 중 접객과 음식 관리 관한 베테랑이며 장례관리사에 따라 장례의 질이 결정되기도 합니다.",
                    desc: "2인 (8시간)",
                    price: "",
                ...
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  <div
                    ...
                    onClick={() =>
                      setDetailModal({
                        title: "고인이송차량",
                        description: "고인께서 임종한 장소가 어디든 고인께서 임종한 장소에서 장례식장까지 모시는 것을 도와드립니다.",
                      })
                    }
                    onKeyDown={(e) =>
                      e.key === "Enter" &&
                  ...
                  <div
                    ...
                    onClick={() =>
                      setDetailModal({
                        title: "리무진/장의버스 택1",
                        description:
                        "[리무진]\n이전 꽃 상여에 관을 모시고 발인하던 것이 현대 리무진으로 바뀐 것입니다. 고인을 화장장 또는 매장지까지 모실 때 품격을 더합니다. \n \n[장의버스]\n장례를 위해 개조되어 만들어진 장의 버스입니다. 기본 45인승 버스이며 발인날 유족과 친지를 모시고 장례식장에서 출발하여 안장까지 마친 후 다시 장례식장까지 안내합니다. 리무진이 없을 때도 관을 모실 수 있도록 설계되어 있습니다. ",
                      })
                    }
                    onKeyDown={(e) =>
                      e.key === "Enter" &&
