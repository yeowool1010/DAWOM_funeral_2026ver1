            ...
            <div className="mt-6 space-y-8">
              <div>
                ...
                <ul className="mt-3 grid gap-3 text-sm text-slate-700 md:grid-cols-2 md:text-base">
                  <li>0.6 오동관 화장용 관</li>
                  <li>화장용 수의 (면 50%, 폴리 50%)</li>
                  <li>입관 수시 용품 15종 (염포, 관보 등)</li>
                  <li>유골함 (오동나무 목함) 무료 제공</li>
                  <li>관 장식용 생화, 계절 생화, 안개꽃</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="mt-3 space-y-2 text-sm text-slate-700 md:text-base">
                  <li>오동나무 목함 → 일반 유골함 변경 시 15만원 추가</li>
                  <li>화장용 수의 → 고급 면 가전수의 변경 시 6만원 추가</li>
                  <li>45인승 장의버스 → 리무진 변경 시 추가 비용 없음 (200km 기준)</li>
                  <li>매장용 관 + 매장 용품 추가 시 35만원 추가</li>
                </ul>
