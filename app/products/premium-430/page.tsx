              ...
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
                {[
                  ...
                  },
                  {
                    name: "남자상복/여자상복",
                    name2:
                      "장례 중 유족이 입는 예복입니다. 남자는 와이셔츠,넥타이가 포함된 정장, 여자는 치마와 저고리로 구성되어 있습니다. ",
                    desc: "남자 8벌, 여자 10벌",
                    price: "",
                    discount: null,
                  ...
                  },
                  {
                    name: "헌화용 국화꽃",
                    name2:
                      "헌화는 장례식장에서 고인에게 꽃을 바쳐 애도와 추모의 마음을 전하는 행위로, 보통 흰 국화를 사용합니다. 일반적으로 30송이 정도 사용해 3일 동안 돌려가며 사용합니다.",
                    desc: "50송이",
                    price: "",
                    free: true,
